...
_Learn about getting started and configuring localization in an Expo project using expo-localization._
...
Use the [`expo-localization`](https://docs.expo.dev/versions/latest/sdk/localization/) library to get the user's current language. Install the package by running the following command:
...
- Other preferences if there's no API to get the default value on platforms you want to support (check [`expo-localization`](https://docs.expo.dev/versions/latest/sdk/localization) API documentation for details)
...
To do so, use the [`expo-localization`](https://docs.expo.dev/versions/latest/sdk/localization/#installation) config plugin and pass the `supportedLocales` property to the `expo-localization` config plugin.
...
If you plan on shipping your app to different countries or regions or want it to support various languages, you can provide [localized](https://docs.expo.dev/versions/latest/sdk/localization) strings for things like the display name and system dialogs. This is easily set up [in the app config](https://docs.expo.dev/workflow/configuration) file. First, set `ios.infoPlist.CFBundleAllowMixedLocalizations: true`, then provide a list of file paths to `locales`.
...
To enable RTL support, use the [`expo-localization`](https://docs.expo.dev/versions/latest/sdk/localization/#installation) config plugin and enable `extra.supportsRTL` property in app config:
